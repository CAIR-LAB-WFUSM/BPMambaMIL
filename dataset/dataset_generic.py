...
from utils.pathology_augmentations import PathologyFeatureAugmentations
...
class Generic_MIL_Dataset(Generic_WSI_Classification_Dataset):
	def __init__(self,
		...
		**kwargs):
		...
		self.patch_size=''
		self.data_cache = {}
		# self.augmenter = PathologyFeatureAugmentations(feature_dim=768)  # Set appropriate feature_dim
